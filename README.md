# StrokeGuard AI
## Team Research Prototype | Arduino UNO Q 2GB

StrokeGuard AI is a collaborative **research and software prototype** for a wearable safety system. It combines:
...
The project is organized as a shared team effort across the following areas:

- Embedded firmware and sensor integration on the Arduino UNO Q MCU.
- Linux edge runtime, data ingestion, and Arduino Bridge/RPC communication.
- Data schemas, preprocessing, feature engineering, and model training.
- Edge inference, risk fusion, and safety policy implementation.
- Dashboard, local API, SOS flows, and optional network notifications.
- Dataset preparation, evaluation, benchmarking, documentation, and testing.

Contributors should keep interfaces and safety contracts documented so each part
of the system can be developed and validated independently.
